...
enum class ErrorCode(
    ...
    RESERVATION_ALREADY_CANCELLED(HttpStatus.CONFLICT, "RESERVATION_ALREADY_CANCELLED", "이미 취소된 예매입니다."),
    CANCELLATION_NOT_ALLOWED(HttpStatus.UNPROCESSABLE_ENTITY, "CANCELLATION_NOT_ALLOWED", "공연 당일에는 취소할 수 없습니다."),
