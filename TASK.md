...
| # | Done | Issue | Title | Deps | Claim | Branch | PR |
|---|------|-------|-------|------|-------|--------|----|
| 9 | [x] | [#53](https://github.com/paircoders/ticket-queue/issues/53) | [Reservation] Kafka Consumer - 결제 이벤트 처리 | #55, #63, #59 | session-7f37ba3c | `feature/53-reservation-payment-consumer` | [#239](https://github.com/paircoders/ticket-queue/pull/239) |
...
| # | Done | Issue | Title | Deps | Claim | Branch | PR |
|---|------|-------|-------|------|-------|--------|----|
| 14 | [ ] | [#121](https://github.com/paircoders/ticket-queue/issues/121) | [Frontend] 마이페이지 (프로필, 예매 내역) | (#27), (#52) | session-0e341b7a | `feature/121-frontend-mypage` | [#245](https://github.com/paircoders/ticket-queue/pull/245) |
...
| 17 | [ ] | [#122](https://github.com/paircoders/ticket-queue/issues/122) | [Frontend] 성능 최적화, SEO 마무리, 번들 분석 | #119, #120, #121 | session-0e341b7a | `feature/122-frontend-perf-seo` | [#247](https://github.com/paircoders/ticket-queue/pull/247) |
