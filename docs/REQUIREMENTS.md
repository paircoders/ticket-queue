...
| 요구사항 ID | 요구사항명 | 요구사항 설명 | 담당자 | 분류 | 필수여부 | 비고 |
|------------|-----------|-------------|-------|------|---------|-----|
| REQ-EVT-001 | 공연 생성 (관리자) | 제목, 아티스트, 일시, 공연장, 좌석 정보 등 입력 | A개발자 | 기능 | 선택 | |
| REQ-EVT-002 | 공연 정보 수정 | 공연 정보 수정 | A개발자 | 기능 | 선택 | |
| REQ-EVT-003 | 공연 삭제 | 공연 정보 삭제 | A개발자 | 기능 | 선택 | |
| REQ-EVT-004 | 공연 목록 조회 | 페이징, 필터링, 정렬, 검색 지원 | A개발자 | 기능 | 필수 | |
| REQ-EVT-005 | 공연 상세 조회 | 상세 정보 및 잔여 좌석 수 표시 | A개발자 | 기능 | 필수 | |
| REQ-EVT-006 | 공연 좌석 정보 조회 | 등급별 좌석 목록 및 상태 조회 | A개발자 | 기능 | 필수 | |
...
| REQ-EVT-010 | 공연장 생성 (관리자) | 공연장명, 주소 등 등록 | A개발자 | 기능 | 선택 | |
| REQ-EVT-011 | 공연장 수정 | 공연장 정보 수정 | A개발자 | 기능 | 선택 | |
| REQ-EVT-012 | 공연장 삭제 | 공연장 정보 삭제 | A개발자 | 기능 | 선택 | |
| REQ-EVT-013 | 홀 정보 생성 | 홀명, 좌석 정보 등록 | A개발자 | 기능 | 선택 | |
...
| 요구사항 ID | 요구사항명 | 요구사항 설명 | 담당자 | 분류 | 필수여부 | 비고 |
|------------|-----------|-------------|-------|------|---------|-----|
| REQ-WAIT-001 | 대기열 진입 | 예매 페이지 접근 시 대기열 진입 | A개발자 | 기능 | 필수 | |
| REQ-WAIT-002 | 대기열 상태 조회 | 현재 순서 및 예상 대기 시간 표시 | A개발자 | 기능 | 필수 | |
